...
extension UIView {
    fileprivate struct Constants {
        ...
        static let curvesAnimationEnd: CGFloat = 0.5 // 0.4'ten 0.5'e artırıldı - daha uzun daralma
        static let slideAnimationStart: CGFloat = 0.4 //0.5'ten 0.4'ye düşürüldü - daha erken başlama
        static let slideAnimationEnd: CGFloat = 1.0
        static let sliceSize: CGFloat = 2.0  // ✅ 3.0'dan 2.0'a düşürüldü - daha ince slice'lar = daha yumuşak daralma
